...
class PublicUserTests(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test an error is returned if passwrod less tha n5 chars"""
    ...
    def test_email_not_formating(self):
        """Test an error returned if email not format"""
    ...
    def test_create_token_blank_password(self):
        """Test posting a blank passwrod return an error."""
